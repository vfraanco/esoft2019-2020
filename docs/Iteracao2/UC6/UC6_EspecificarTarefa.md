...
|  		 |	... cria instância de Tarefa? | ListaTarefas | Creator (Regra1) + HC/LC: no MD a Organizacao possui Tarefa. Por HC/LC delega essas responsabilidade em ListaTarefas.  |
...
| 4. O sistema mostra a lista de categorias e pede ao colaborador de organização para selecionar uma.  		 |	... conhece a lista de categorias?  |  RegistoCategorias  | IE: RegistoCategorias possui todas as instâncias de Categoria.                             |
