...
public class Utils
{
    ...
    static public Time readTimeFromConsole(String strPrompt)
    {
        do
        {
            try
            {
                String strTime = readLineFromConsole(strPrompt);
                DateTimeFormatter tf = DateTimeFormatter.ofPattern("HH:MM");
                Time time = (Time) tf.parse(strTime);
